...
export function CreateAccountModal({
  ...
  const handleEmailSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!signupResult.success) {
        setError(signupResult.error || t('auth.accountCreationFailed'));
        setLoading(false);
        return;
      }
  ...
  return (
    <Modal
      ...
      description={t('auth.saveProgressDesc')}
      size="md"
    >
      <ModalBody>
              ...
              <form onSubmit={handleEmailSignup} className="space-y-4">
                ...
                <Button
                  ...
                  fullWidth
                  loading={loading}
                  ariaLabel={t('auth.createMyAccount')}
                >

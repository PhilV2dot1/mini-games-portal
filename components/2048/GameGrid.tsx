...
export function GameGrid({ grid }: GameGridProps) {
  return (
    ...
    >
      <div
        className="grid grid-cols-4 gap-3 p-4 bg-white/95 dark:bg-gray-800/95 backdrop-blur-lg rounded-2xl shadow-xl border-2 border-gray-700 dark:border-gray-500"

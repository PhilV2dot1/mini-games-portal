...
export const translations = {
  en: {
    ...
    games: {
      ...
      watersort: {
        ...
        moves: 'Moves', bestMoves: 'Best', newGame: 'New Game', playAgain: 'Play Again',
        win: '🎉 Sorted! All cryptos matched!', difficulty: 'Difficulty',
        viewOnExplorer: 'View on Explorer →',
      },
    },
  ...
  fr: {
    ...
    games: {
      ...
      watersort: {
        ...
        moves: 'Coups', bestMoves: 'Meilleur', newGame: 'Nouvelle partie', playAgain: 'Rejouer',
        win: '🎉 Trié ! Toutes les cryptos sont assemblées !', difficulty: 'Difficulté',
        viewOnExplorer: 'Voir sur l\'Explorer →',
      },
    },
  ...
  pt: {
    ...
    games: {
      ...
      watersort: { title: 'Water Sort Crypto', subtitle: 'Ordene os líquidos crypto — despeje e combine cores!', howToPlay: 'Como Jogar', rule1: 'Toque um tubo para selecioná-lo, depois toque outro para despejar', rule2: 'Você só pode despejar se as cores do topo coincidirem', rule3: 'Um tubo pode conter no máximo 4 segmentos', rule4: 'Vença quando cada tubo contiver apenas uma crypto!', easy: 'Fácil', medium: 'Médio', hard: 'Difícil', moves: 'Movimentos', bestMoves: 'Melhor', newGame: 'Nova partida', playAgain: 'Jogar novamente', win: '🎉 Ordenado! Todas as cryptos combinadas!', difficulty: 'Dificuldade', viewOnExplorer: 'Ver no Explorer →' },
    },

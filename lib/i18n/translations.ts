...
export const translations = {
  ...
  es: {
    ...
    games: {
      ...
      memory: { title: 'Memoria', subtitle: '¡Encuentra los pares de cartas!', howToPlay: 'Cómo Jugar', rule1: 'Voltea dos cartas por turno para encontrar pares', rule2: 'Recuerda las posiciones para encontrar pares más rápido', rule3: '¡Encuentra todos los pares para ganar — menos movimientos = mejor puntuación!', pairs: 'Pares', moves: 'Movimientos', pairsFound: 'Pares Encontrados', clickToStart: '¡Haz clic en Iniciar para comenzar!', viewOnCeloscan: 'Ver en Explorer →' },
  ...
  pt: {
    ...
    games: {
      ...
      memory: { title: 'Memória', subtitle: 'Encontre os pares de cartas!', howToPlay: 'Como Jogar', rule1: 'Vire duas cartas por turno para encontrar pares', rule2: 'Memorize as posições para encontrar pares mais rápido', rule3: 'Encontre todos os pares para vencer — menos movimentos = melhor pontuação!', pairs: 'Pares', moves: 'Movimentos', pairsFound: 'Pares Encontrados', clickToStart: 'Clique em Iniciar para começar!', viewOnCeloscan: 'Ver no Explorer →' },

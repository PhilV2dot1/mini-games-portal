...
export const translations = {
  en: {
    ...
    games: {
      ...
      coinflip: {
        ...
        waitingTx: '⏳ Waiting for blockchain confirmation...',
      ...
      spaceinvaders: {
        ...
        subtitle: 'Defend Earth from the crypto invasion!',
        howToPlay: 'How to Play',
        rule1: 'Move left/right with arrow keys or the on-screen buttons',
        rule2: 'Press Space or the FIRE button to shoot at the invaders',
        rule3: 'Destroy all enemies to advance to the next wave — they speed up!',
        rule4: 'Use the bunkers for cover — they erode when hit. Shoot the UFO for 500 pts!',
        lives: 'Lives',
        score: 'Score',
        wave: 'Wave',
        highScore: 'Best',
        ...
        fire: 'FIRE',
        stats: 'My Stats',
        footer: 'Space Invaders — defend Earth from the crypto invasion!',
        viewOnExplorer: 'View on Explorer →',
      },
      arrowescape: {
        title: 'Arrow Escape',
        subtitle: 'Tap arrows to slide them out — clear the grid!',
        howToPlay: 'How to Play',
        rule1: 'Tap an arrow tile to slide it toward the grid edge',
        rule2: 'If the path to the edge is clear, the arrow escapes!',
        rule3: 'If another arrow is in the way, you lose a life ❤️',
        rule4: 'Clear all arrows to complete the level',
        level: 'Level',
        score: 'Score',
        arrows: 'Arrows',
        hint: 'Hint 💡',
      ...
      hilo: {
        title: 'Hi-Lo',
        subtitle: 'Higher or Lower — ride your streak, cash out before you fall!',
        howToPlay: 'How to Play',
        rule1: 'A card is drawn — guess if the next will be Higher ↑ or Lower ↓',
        rule2: 'Equal cards are a Push — no streak change, keep going!',
        rule3: 'Build your streak to unlock multipliers: ×1 → ×2 → ×3 → ×5 → ×10',
        rule4: 'At streak ≥ 2 you can Cash Out and keep your score',
        rule5: 'Wrong guess = Game Over! Use probability hints wisely.',
        higher: 'Higher',
        lower: 'Lower',
        equal: 'Equal',
        current: 'Current',
        ...
        bestStreak: 'Best Streak',
        correct: 'Correct',
        multipliers: 'Streak Multipliers',
        cashOut: 'Cash Out',
        cashedOut: 'Cashed Out!',
        gameOver: 'Game Over!',
        startGame: 'Start Game',
        playAgain: 'Play Again',
        waitingStart: '⏳ Waiting for blockchain confirmation...',
        waitingEnd: '⏳ Recording result on-chain...',
        history: 'History',
        cardsLeft: 'cards left in deck',
        stats: 'My Stats',
        footer: 'Hi-Lo — ride the streak, cash out at the right time!',
        viewOnExplorer: 'View on Explorer →',
      },
      cryptohigherlower: {
        ...
        rule3: 'Correct? Token B becomes the new Token A — keep the chain going!',
        rule4: 'Streak ×2 from round 3, ×3 from round 6. Hard mode adds ×1.5.',
        rule5: 'One wrong answer ends the game. Max 10 rounds.',
        higher: 'Higher',
        lower: 'Lower',
        streak: 'Streak',
        round: 'Round',
        ...
        medium: 'Medium',
        hard: 'Hard',
        easyHint: 'Top 10 + hints',
        mediumHint: 'Top 50 + hints',
        hardHint: 'All + ×1.5 score',
        startGame: 'Start Game',
        playAgain: 'Play Again',
        gameOver: 'Game Over!',
        ...
        hardMode: 'Hard mode',
        applied: 'applied',
        walletBonus: 'Holder bonus',
        walletHolderBonus: 'Wallet holder bonus',
        wrong: 'Wrong!',
        mult: 'Mult',
        total: 'Total',
        roundHistory: 'Round History',
        resultRecorded: 'Result recorded on-chain',
        onChainRecorded: '✅ Result recorded on-chain',
        waitingStart: 'Sign the transaction to start your on-chain session…',
        waitingEnd: 'Recording result on-chain…',
        fetchingPrices: 'Fetching live prices…',
        retrying: 'Retrying…',
        pricesVia: 'Prices via CoinGecko · refreshed every 60s',
        viewContract: 'View contract on',
        onchainAvailable: 'On-chain mode available · sign in with wallet',
        footer: 'Prices via CoinGecko · refreshed every 60s',
  ...
  fr: {
    ...
    games: {
      ...
      coinflip: {
        ...
        waitingTx: '⏳ En attente de confirmation blockchain...',
        flipAgain: 'Rejouer',
        win: 'Bien joué ! 🎉',
        lose: 'Pas de chance...',
        streak: 'Série',
      ...
      spaceinvaders: {
        title: 'Space Invaders',
        subtitle: 'Défends la Terre contre l\'invasion crypto !',
        howToPlay: 'Comment jouer',
        rule1: 'Déplace-toi avec les flèches ou les boutons à l\'écran',
        rule2: 'Appuie sur Espace ou le bouton TIR pour tirer sur les envahisseurs',
        rule3: 'Détruis tous les ennemis pour passer à la vague suivante — ils accélèrent !',
        rule4: 'Utilise les bunkers comme couverture. Tire sur l\'OVNI pour 500 pts !',
        lives: 'Vies',
        score: 'Score',
        wave: 'Vague',
        highScore: 'Meilleur',
        gameOver: 'Game Over !',
        victory: 'Terre sauvée !',
        startGame: 'Commencer',
        playAgain: 'Rejouer',
        fire: 'TIR',
        stats: 'Mes Stats',
        footer: 'Space Invaders — défends la Terre contre l\'invasion crypto !',
        viewOnExplorer: 'Voir sur l\'Explorer →',
      },
      arrowescape: {
        title: 'Arrow Escape',
        subtitle: 'Glisse les flèches hors de la grille — vide tout !',
        howToPlay: 'Comment jouer',
        rule1: 'Tape sur une flèche pour la faire glisser vers le bord',
        rule2: 'Si le chemin est libre, la flèche s\'échappe !',
        rule3: 'Si une autre flèche bloque, tu perds une vie ❤️',
        rule4: 'Libère toutes les flèches pour terminer le niveau',
        level: 'Niveau',
        score: 'Score',
        arrows: 'Flèches',
        hint: 'Indice 💡',
      ...
      hilo: {
        title: 'Hi-Lo',
        subtitle: 'Plus Haut ou Plus Bas — enchaîne les bonnes réponses, encaisse avant de tomber !',
        howToPlay: 'Comment jouer',
        rule1: 'Une carte est tirée — devine si la suivante sera Plus Haut ↑ ou Plus Bas ↓',
        rule2: 'Une carte égale est un Push — ta série ne change pas, continue !',
        rule3: 'Construis ta série pour débloquer des multiplicateurs : ×1 → ×2 → ×3 → ×5 → ×10',
        rule4: 'À partir d\'une série de 2, tu peux Encaisser et garder ton score',
        rule5: 'Une mauvaise réponse = Game Over ! Utilise les probabilités affichées.',
        higher: 'Plus Haut',
        lower: 'Plus Bas',
        equal: 'Égal',
        current: 'Actuelle',
        ...
        multipliers: 'Multiplicateurs de Série',
        cashOut: 'Encaisser',
        cashedOut: 'Encaissé !',
        gameOver: 'Game Over !',
        startGame: 'Commencer',
        playAgain: 'Rejouer',
        waitingStart: '⏳ En attente de confirmation blockchain...',
        waitingEnd: '⏳ Enregistrement du résultat on-chain...',
        history: 'Historique',
        cardsLeft: 'cartes restantes',
        stats: 'Mes Stats',
        footer: 'Hi-Lo — enchaîne les bonnes réponses, encaisse au bon moment !',
        viewOnExplorer: 'Voir sur l\'Explorer →',
      },
      cryptohigherlower: {
        title: 'Crypto Plus Haut / Plus Bas',
        subtitle: 'Devine quelle crypto a le prix le plus élevé — enchaîne les bonnes réponses !',
        howToPlay: 'Comment jouer',
        rule1: 'Le Token A est affiché avec son prix en temps réel. Le Token B est masqué.',
        rule2: 'Devine : le prix du Token B est-il Plus Haut ▲ ou Plus Bas ▼ que le Token A ?',
        rule3: 'Bonne réponse ? Le Token B devient le nouveau Token A — enchaîne !',
        rule4: 'Série ×2 à partir du round 3, ×3 à partir du round 6. Mode Difficile ajoute ×1.5.',
        rule5: 'Une mauvaise réponse met fin à la partie. Maximum 10 rounds.',
        higher: 'Plus Haut',
        lower: 'Plus Bas',
        streak: 'Série',
        round: 'Round',
        ...
        medium: 'Moyen',
        hard: 'Difficile',
        easyHint: 'Top 10 + indices',
        mediumHint: 'Top 50 + indices',
        hardHint: 'Tout + ×1.5 score',
        startGame: 'Commencer',
        playAgain: 'Rejouer',
        gameOver: 'Game Over !',
        ...
        applied: 'appliqué',
        walletBonus: 'Bonus détenteur',
        walletHolderBonus: 'Bonus détenteur de wallet',
        wrong: 'Raté !',
        mult: 'Mult',
        total: 'Total',
        roundHistory: 'Historique des Rounds',
        resultRecorded: 'Résultat enregistré on-chain',
        onChainRecorded: '✅ Résultat enregistré on-chain',
        waitingStart: 'Signez la transaction pour démarrer votre session on-chain…',
        waitingEnd: 'Enregistrement du résultat on-chain…',
        fetchingPrices: 'Récupération des prix en direct…',
        retrying: 'Nouvelle tentative…',
        pricesVia: 'Prix via CoinGecko · actualisés toutes les 60s',
        viewContract: 'Voir le contrat sur',
        onchainAvailable: 'Mode on-chain disponible · connectez votre wallet',
        footer: 'Prix via CoinGecko · actualisés toutes les 60s',
        viewOnExplorer: 'Voir le contrat sur l\'Explorer →',
      },
    },
  ...
  es: {
    ...
    games: {
      ...
      plinko: { title: 'Plinko Crypto', subtitle: '¡Lanza BTC por las clavijas — multiplica tus monedas!', howToPlay: 'Cómo Jugar', rule1: 'Mueve el ratón o desliza para apuntar la zona de lanzamiento', rule2: 'Presiona Espacio o haz clic para lanzar una moneda BTC', rule3: 'Las monedas rebotan en las clavijas y aterrizan en casillas multiplicadoras', rule4: '¡Alcanza 10 000 monedas para ganar — no quiebres!', tapToDrop: 'Toca para lanzar una moneda', coins: 'Monedas', bet: 'Apuesta', multiplier: 'Multiplicador', best: 'Mejor', win: '🎉 ¡Alcanzaste 10 000 monedas — Ganador!', lose: '💸 ¡Quiebra! Sin monedas.', controls: 'Mueve para apuntar · Espacio o Clic para lanzar', stats: 'Tus Stats', footer: 'Plinko Crypto — ¡Bitcoin rebotando en el mercado!', endGame: 'Terminar y Guardar', viewOnExplorer: 'Ver en Explorer' },
      watersort: { title: 'Water Sort Crypto', subtitle: '¡Ordena los líquidos crypto — vierte y combina colores!', howToPlay: 'Cómo Jugar', rule1: 'Toca un tubo para seleccionarlo, luego toca otro para verter', rule2: 'Solo puedes verter si los colores superiores coinciden', rule3: 'Un tubo puede contener máximo 4 segmentos', rule4: '¡Gana cuando cada tubo contenga solo una crypto!', easy: 'Fácil', medium: 'Medio', hard: 'Difícil', moves: 'Movimientos', bestMoves: 'Mejor', newGame: 'Nueva Partida', playAgain: 'Jugar de nuevo', win: '🎉 ¡Ordenado! ¡Todas las cryptos coinciden!', chooseDifficulty: 'Elegir dificultad', startGame: '▶ Iniciar', abandon: 'Abandonar', difficulty: 'Dificultad', viewOnExplorer: 'Ver en Explorer →' },
      arrowescape: { title: 'Arrow Escape', subtitle: '¡Desliza las flechas fuera de la cuadrícula — vacíala toda!', howToPlay: 'Cómo Jugar', rule1: 'Toca una flecha para deslizarla hacia el borde', rule2: 'Si el camino está libre, ¡la flecha escapa!', rule3: 'Si otra flecha bloquea, pierdes una vida ❤️', rule4: 'Libera todas las flechas para completar el nivel', level: 'Nivel', score: 'Puntos', arrows: 'Flechas', hint: 'Pista 💡', restart: 'Reiniciar 🔄', nextLevel: 'Nivel siguiente →', playAgain: 'Intentar de nuevo', win: '¡Nivel completado!', lost: '¡Sin vidas!', viewOnExplorer: 'Ver en Explorer →' },
      hilo: { title: 'Hi-Lo', subtitle: '¿Más Alto o Más Bajo? — ¡encadena racha y cobra antes de caer!', howToPlay: 'Cómo Jugar', rule1: 'Se saca una carta — adivina si la siguiente será Más Alta ↑ o Más Baja ↓', rule2: 'Una carta igual es un Empate — sin cambio de racha, ¡sigue!', rule3: 'Construye tu racha para desbloquear multiplicadores: ×1 → ×2 → ×3 → ×5 → ×10', rule4: 'Con racha ≥ 2 puedes Cobrar y guardar tu puntuación', rule5: 'Una respuesta incorrecta = ¡Game Over! Usa las probabilidades mostradas.', higher: 'Más Alto', lower: 'Más Bajo', equal: 'Igual', current: 'Actual', next: 'Siguiente', value: 'Valor', streak: 'Racha', bestStreak: 'Mejor Racha', correct: 'Correctas', multipliers: 'Multiplicadores de Racha', cashOut: 'Cobrar', cashedOut: '¡Cobrado!', gameOver: '¡Game Over!', startGame: 'Iniciar Partida', playAgain: 'Jugar de nuevo', history: 'Historial', cardsLeft: 'cartas restantes', stats: 'Mis Stats', footer: 'Hi-Lo — ¡encadena y cobra en el momento justo!', viewOnExplorer: 'Ver en Explorer →' },
    },
  ...
  pt: {
    ...
    games: {
      ...
      plinko: { title: 'Plinko Crypto', subtitle: 'Solte BTC pelas estacas — multiplique suas moedas!', howToPlay: 'Como Jogar', rule1: 'Mova o mouse ou arraste para mirar a zona de lançamento', rule2: 'Pressione Espaço ou clique para soltar uma moeda BTC', rule3: 'As moedas ricocheteiam nas estacas e pousam em caixas multiplicadoras', rule4: 'Alcance 10 000 moedas para vencer — não vá à falência!', tapToDrop: 'Toque para soltar uma moeda', coins: 'Moedas', bet: 'Aposta', multiplier: 'Multiplicador', best: 'Melhor', win: '🎉 Você alcançou 10 000 moedas — Vencedor!', lose: '💸 Falência! Sem moedas.', controls: 'Mova para mirar · Espaço ou Clique para soltar', stats: 'Suas Stats', footer: 'Plinko Crypto — Bitcoin ricocheteando no mercado!', endGame: 'Terminar e Salvar', viewOnExplorer: 'Ver no Explorer' },
      watersort: { title: 'Water Sort Crypto', subtitle: 'Ordene os líquidos crypto — despeje e combine as cores!', howToPlay: 'Como Jogar', rule1: 'Toque em um tubo para selecioná-lo, depois toque em outro para despejar', rule2: 'Você só pode despejar se as cores do topo coincidirem', rule3: 'Um tubo pode conter no máximo 4 segmentos', rule4: 'Vença quando cada tubo contiver apenas uma crypto!', easy: 'Fácil', medium: 'Médio', hard: 'Difícil', moves: 'Movimentos', bestMoves: 'Melhor', newGame: 'Nova Partida', playAgain: 'Jogar novamente', win: '🎉 Ordenado! Todas as cryptos combinaram!', chooseDifficulty: 'Escolher dificuldade', startGame: '▶ Iniciar', abandon: 'Abandonar', difficulty: 'Dificuldade', viewOnExplorer: 'Ver no Explorer →' },
      arrowescape: { title: 'Arrow Escape', subtitle: 'Deslize as setas para fora da grade — esvazie tudo!', howToPlay: 'Como Jogar', rule1: 'Toque em uma seta para deslizá-la em direção à borda', rule2: 'Se o caminho estiver livre, a seta escapa!', rule3: 'Se outra seta bloquear, você perde uma vida ❤️', rule4: 'Libere todas as setas para completar o nível', level: 'Nível', score: 'Pontos', arrows: 'Setas', hint: 'Dica 💡', restart: 'Reiniciar 🔄', nextLevel: 'Próximo nível →', playAgain: 'Tentar novamente', win: 'Nível concluído!', lost: 'Sem vidas!', viewOnExplorer: 'Ver no Explorer →' },
      hilo: { title: 'Hi-Lo', subtitle: 'Mais Alto ou Mais Baixo? — encadeie sequência e saque antes de cair!', howToPlay: 'Como Jogar', rule1: 'Uma carta é sacada — adivinhe se a próxima será Mais Alta ↑ ou Mais Baixa ↓', rule2: 'Uma carta igual é um Empate — sem mudança na sequência, continue!', rule3: 'Construa sua sequência para desbloquear multiplicadores: ×1 → ×2 → ×3 → ×5 → ×10', rule4: 'Com sequência ≥ 2 você pode Sacar e guardar sua pontuação', rule5: 'Uma resposta errada = Game Over! Use as probabilidades exibidas.', higher: 'Mais Alto', lower: 'Mais Baixo', equal: 'Igual', current: 'Atual', next: 'Próxima', value: 'Valor', streak: 'Sequência', bestStreak: 'Melhor Sequência', correct: 'Corretas', multipliers: 'Multiplicadores de Sequência', cashOut: 'Sacar', cashedOut: 'Sacado!', gameOver: 'Game Over!', startGame: 'Iniciar Partida', playAgain: 'Jogar Novamente', history: 'Histórico', cardsLeft: 'cartas restantes', stats: 'Minhas Stats', footer: 'Hi-Lo — encadeie e saque no momento certo!', viewOnExplorer: 'Ver no Explorer →' },
    },

...
export const translations = {
  en: {
    ...
    games: {
      ...
      arrowescape: {
        title: 'Arrow Escape',
        subtitle: 'Navigate arrows to reach the exit — avoid enemies!',
        howToPlay: 'How to Play',
        rule1: 'Use arrow keys, WASD or on-screen buttons to move',
        rule2: 'Landing on an arrow tile slides you in its direction',
        rule3: 'Reach the green exit ⬡ to win the level',
        rule4: 'Avoid red enemies — they patrol and will catch you!',
        easy: 'Easy',
        medium: 'Medium',
        hard: 'Hard',
        moves: 'Moves',
        ...
        newGame: 'New Game',
        playAgain: 'Try Again',
        win: 'Escaped! You reached the exit!',
        lost: 'Caught! An enemy got you.',
        viewOnExplorer: 'View on Explorer →',
      },
    },
  ...
  fr: {
    ...
    games: {
      ...
      arrowescape: {
        title: 'Arrow Escape',
        subtitle: 'Navigue les flèches pour atteindre la sortie — évite les ennemis !',
        howToPlay: 'Comment jouer',
        rule1: 'Utilise les touches directionnelles, WASD ou les boutons à l\'écran',
        rule2: 'Atterrir sur une flèche te propulse dans sa direction',
        rule3: 'Atteins la sortie verte ⬡ pour gagner le niveau',
        rule4: 'Évite les ennemis rouges — ils patrouillent et peuvent t\'attraper !',
        easy: 'Facile',
        medium: 'Moyen',
        hard: 'Difficile',
        moves: 'Coups',
        ...
        newGame: 'Nouvelle partie',
        playAgain: 'Réessayer',
        win: 'Échappé ! Tu as atteint la sortie !',
        lost: 'Attrapé ! Un ennemi t\'a eu.',
        viewOnExplorer: 'Voir sur l\'Explorer →',
      },
    },
  ...
  es: {
    ...
    games: {
      ...
      arrowescape: { title: 'Arrow Escape', subtitle: '¡Navega las flechas para llegar a la salida — esquiva los enemigos!', howToPlay: 'Cómo Jugar', rule1: 'Usa las teclas de dirección, WASD o los botones en pantalla', rule2: 'Aterrizar en una flecha te desliza en su dirección', rule3: 'Llega a la salida verde ⬡ para ganar el nivel', rule4: '¡Evita los enemigos rojos — patrullan y pueden atraparte!', easy: 'Fácil', medium: 'Medio', hard: 'Difícil', moves: 'Movimientos', level: 'Nivel', bestLevel: 'Mejor', newGame: 'Nueva Partida', playAgain: 'Intentar de nuevo', win: '¡Escapado! ¡Llegaste a la salida!', lost: '¡Atrapado! Un enemigo te alcanzó.', viewOnExplorer: 'Ver en Explorer →' },
    },
  ...
  pt: {
    ...
    games: {
      ...
      arrowescape: { title: 'Arrow Escape', subtitle: 'Navegue pelas setas para chegar à saída — evite os inimigos!', howToPlay: 'Como Jogar', rule1: 'Use as teclas direcionais, WASD ou os botões na tela', rule2: 'Pousar em uma seta te desliza na sua direção', rule3: 'Alcance a saída verde ⬡ para vencer o nível', rule4: 'Evite os inimigos vermelhos — eles patrulham e podem te pegar!', easy: 'Fácil', medium: 'Médio', hard: 'Difícil', moves: 'Movimentos', level: 'Nível', bestLevel: 'Melhor', newGame: 'Nova Partida', playAgain: 'Tentar novamente', win: 'Escapou! Você chegou à saída!', lost: 'Pego! Um inimigo te alcançou.', viewOnExplorer: 'Ver no Explorer →' },
    },

...
export default function LeaderboardPage() {
  ...
  const initialTab = searchParams.get('tab') === 'season' ? 'season' : searchParams.get('tab') === 'challenges' ? 'challenges' : 'scores';
  const [viewMode, setViewMode] = useState<'scores' | 'challenges' | 'season'>(initialTab);
